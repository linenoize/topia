...
- `topic` — what the video is about (e.g. "Topia plugin demo", "Feature X walkthrough")
...
Duration: 12s
Visual: Terminal window, typed command "npm install -g @Topia/cli", output scrolling
...
Shot 2 — Terminal
  Command: npm install -g @Topia/cli && Topia init my-project
