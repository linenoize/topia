...
Runs all automated checks (lint, type-check, tests, build) to verify code health after any change. Stateless — executes checks and reports structured results.
...
- `build` (L1): Phase 6 VERIFY — final check before commit
