...
- `/topia incident "description of what's broken"` — direct user invocation
...
- User: `/topia incident` direct invocation
...
Invoke `journal` to record the timeline and decisions in `.topia/adr/` as an incident ADR.

### Step 7 — Postmortem

Generate postmortem report and save as `.topia/incidents/INCIDENT-[YYYY-MM-DD]-[slug].md`:
...
### Postmortem saved
.topia/incidents/INCIDENT-2026-02-24-login-503.md
```
