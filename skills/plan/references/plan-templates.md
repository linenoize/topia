...
Save to `.topia/plan-<feature>.md`. Max 80 lines.
...
Save to `.topia/plan-<feature>-phase<N>.md`. Max 200 lines.
...
Every requirement from idea's Requirements Document MUST appear in this matrix. Missing requirement = incomplete phase. `completion-gate` checks this matrix during verification.
