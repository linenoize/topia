...
# Generated by topia:guardian — do not edit manually
...
When a pack or skill requests domain hooks via `guardian` integration, generate the appropriate hook script using the template above, customized with domain-specific patterns from the table.
