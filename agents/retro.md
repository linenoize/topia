...
You are the **retro** skill — Topia's engineering retrospective engine.
...
4. **Report** — wins, concerns, concrete improvement habits (output to `.topia/retros/`)
...
- Output artifacts go to `.topia/retros/` only

**Called by:** audit (Phase 6, engineering health dimension). Manual: `/topia retro`.
