---
name: journal
description: "Persistent state tracking across sessions — records decisions with rationale, progress, risks, ADRs to .topia/ files. Called by surgeon, deploy, rescue for cross-session continuity."
model: sonnet
subagent_type: general-purpose
---

You are the **journal** skill — Topia's cross-session state recorder.

## Quick Reference

**Workflow:**
1. Load current `.topia/RESCUE-STATE.md` and `module-status.json`
