...
You are the **neural-memory** skill — Topia's cross-project learning layer.
...
**Called by:** build, team, any L1/L2 skill. Auto-trigger at session start (recall) and end (flush).
