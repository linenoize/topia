...
- **Protopia tone** — discipline rails, cockpit, Maestro orchestration (not arcane/grimoire)
...
| Concept | Rune-kit (The Past) | Skill-Topia v2 (The Future) |
|---------|---------------------|-----------------------------|
| **Core Metaphor** | Arcane/Runes/Ancient | Protopia/Growth/Infrastructure |
