...
console.log(`    ${dim}• register via linenoize marketplace (or claude plugin add . fallback)${reset}`);
console.log(`    ${dim}• wire discipline hooks globally (readiness / guardian / completion-gate / quarantine)${reset}`);
